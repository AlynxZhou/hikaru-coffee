...
(function() {
    ...
    registerInternalGenerators() {
      ...
      */
      ...
      return this.generator.register(["post", "page"], function(page, posts, ctx) {
        var $, a, h, hNames, headings, href, i, imgs, j, l, len, len1, len2, level, links, m, src, toc;
  ...
  paginate = function(page, posts, ctx, perPage) {
    var i, j, l, len, perPagePosts, post, ref, results;
    if (!perPage) {
      perPage = 10;
    }
    results = [];
    ...
    for (i = l = 1, ref = results.length; (1 <= ref ? l < ref : l > ref); i = 1 <= ref ? ++l : --l) {
