...
(function() {
  var Generator, Hikaru, Logger, Renderer, Router, cheerio, coffee, fse, highlight, marked, nib, nunjucks, paginate, path, stylus, yaml;
  ...
  module.exports = Hikaru = class Hikaru {
    ...
    registerInternalGenerators() {
      ...
      */
      this.generator.register("tags", (page, posts) => {
      ...
      return this.generator.register(["post", "page"], function(page, posts) {
