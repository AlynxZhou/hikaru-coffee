...
(function() {
  var Category, File, Generator, Hikaru, Logger, Processer, Promise, Renderer, Router, Site, Tag, Translator, URL, cheerio, colors, escapeHTML, fse, genToc, getPathFn, getURLFn, highlight, marked, matchFiles, moment, nib, nunjucks, paginate, paginateCategories, path, removeControlChars, resolveHeaderIds, resolveImage, resolveLink, sortCategories, stylus, utils, yaml;
