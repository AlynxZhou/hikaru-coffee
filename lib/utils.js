...
(function() {
  var Category, File, Promise, Site, Tag, URL, escapeHTML, fm, genToc, getContentType, getPathFn, getURLFn, getVersion, glob, highlight, isCurrentPathFn, matchFiles, packageJSON, paginate, paginateCategories, parseFrontMatter, path, removeControlChars, resolveHeaderIds, resolveImage, resolveLink, sortCategories;
