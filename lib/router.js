...
(function() {
  var Category, File, Promise, Router, Site, Tag, URL, chokidar, colors, fse, getContentType, getPathFn, getURLFn, http, isCurrentPathFn, matchFiles, moment, packageJSON, parseFrontMatter, path, yaml;
  ...
  ({matchFiles, getPathFn, getURLFn, getContentType, isCurrentPathFn, parseFrontMatter} = require("./utils"));
