  ...
  module.exports = Router = class Router {
    ...
    route() {
      ...
      return this.routeTemplates().then(() => {
        ...
        var all, generatedPages, generatedPosts, i, j, k, l, len, len1, len2, len3, len4, len5, m, n, o, p, page, post, q, ref, ref1, ref2, ref3, ref4, results, search;
        ...
        // Posts.
        this.posts.sort(dateStrCompare);
        generatedPosts = [];
        ref = this.posts;
        ...
        for (m = 0, len2 = ref2.length; m < len2; m++) {
          page = ref2[m];
          if (!(page["layout"] in this.templates)) {
            page["layout"] = "page";
          }
        ...
        for (n = 0, len3 = all.length; n < len3; n++) {
          ...
          search.push({
            "title": p["title"],
            "url": path.posix.join(this.siteConfig["rootDir"], p["docPath"]),
            "content": p["text"]
          });
        }
        ...
        for (o = 0, len4 = ref3.length; o < len4; o++) {
          page = ref3[o];
          page["content"] = (await this.templates[page["layout"]](page));
        ...
        for (q = 0, len5 = ref4.length; q < len5; q++) {
          post = ref4[q];
          post["content"] = (await this.templates[post["layout"]](post));
