      ...
      for (j = 0, len = ref.length; j < len; j++) {
        ...
        results.push(((event) => {
          return this.themeWatcher.on(event, async(srcPath) => {
            ...
            this.site.set("pages", this.unProcessedPages);
            this.site.set("posts", this.unProcessedPosts);
            this.unProcessedPages = this.site.get("pages").slice(0);
            this.unProcessedPosts = this.site.get("posts").slice(0);
            file = {
